...
MIDDLEWARE = [
    ...
    # Supabase token middleware: attaches request.supabase_user when an Authorization: Bearer <token> header is present
    'codora_backend.supabase_auth.SupabaseAuthMiddleware',
